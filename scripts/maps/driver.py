...
INPUT_FILE = os.path.join(SCRIPT_DIR, "specs", "test.json")
OUTPUT_SVG = os.path.join(SCRIPT_DIR, "output", "test.svg")
OUTPUT_PNG = os.path.join(SCRIPT_DIR, "output", "test.png")
OUTPUT_WIDTH = 2400
