...
class PrintingServiceDataGenerator:
    ...
    def generate_system_configuration(self):
        ...
        for file_type in file_types:
            ...
            # Get a staff member for updated_by if available
            updater_staff_id = None
            if hasattr(self, 'staff_members') and self.staff_members:
                updater_staff_id = self.staff_members[0]['staff_id']
